...
struct charcoalReferences: View {
                    ...
                    ToolbarItem() {
                        NavigationLink(destination: charcoalMaterials()) {
                            Image(systemName: "doc.text")
                                .resizable()
                                .foregroundColor(Color(red: 0.545, green: 0.37254901960784315, blue: 0.4))
                                .scaledToFit()
                                .frame(width: 40, height: 40)
                                .fontWeight(.medium)
                                .padding(15)
                                    ...
                                    ToolbarItem() {
                                        NavigationLink(destination: charcoalReferences()) {
                                            Image(systemName: "folder")
                                                .resizable()
                                                .foregroundColor(Color(red: 0.824, green: 0.378, blue: 0.655))
                                                .scaledToFit()
                                                .frame(width: 40, height: 40)
                                                .fontWeight(.medium)
                                                .padding(.trailing, 15)
...
struct charcoalReferences_Previews: PreviewProvider {

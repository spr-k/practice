        ...
        NavigationStack{
            ZStack{
                ...
                VStack{
                    ...
                    Link(destination: URL(string: "https://nitramcharcoal.com/blogs/blog/history-charcoal")!){
                        Text("- The History of Charcoal from nitramcharcoal.com")
                            .font(.title2)
                    ...
                    ToolbarItem() {
                        NavigationLink(destination: charcoalMaterials()) {
                            Image(systemName: "doc.text")
                                .resizable()
                                .foregroundColor(Color(red: 0.5411764705882353, green: 0.37254901960784315, blue: 0.4))
                                .scaledToFit()
                                .frame(width: 40, height: 40)
                                .fontWeight(.medium)
                                .padding(15)
...
struct charcoalHistory_Previews: PreviewProvider {
